...
import portfo_theme_default from "portfo-theme/src/index";
...
if (module["hot"]) {
  module["hot"].accept(
    ...
    () => {
      ...
      const portfo_theme_default = require("portfo-theme/src/index").default;
